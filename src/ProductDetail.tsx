                ...
                <div className="flex flex-wrap gap-4">
                  {product.colors.map(color => (
                    <button
                      ...
                      title={color.name}
                      className={`w-10 h-10 rounded-full border-2 transition-all p-0.5 ${selectedColor === color.name ? 'border-brand-gold' : 'border-transparent'}`}
                    >
                      <div 
                ...
                <div className="flex flex-wrap gap-3">
                  {product.sizes.map(size => (
                    <button
                      ...
                      className={`w-12 h-12 flex items-center justify-center text-xs border transition-all ${selectedSize === size ? 'border-brand-gold text-brand-gold bg-brand-gold/5' : 'border-white/10 text-white/60 hover:border-white/30'}`}
                    >
                      {size}
                    </button>
                  ))}
